...
export function ConferenceAnnounce({
  ...
  return (
    ...
    >
      <div className="editorial-grid items-center py-2.5 md:py-3">
        <div className="col-span-12 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
          <p className="text-[13px] leading-snug text-ink/95 md:text-sm">
            <span className="label-mono mr-2 text-[10px] tracking-[0.12em] text-ink/70">
          ...
          <Link
            href={href}
            className="label-mono inline-flex shrink-0 items-center gap-2 self-start border border-ink/35 bg-ink/10 px-3.5 py-2 text-[10px] tracking-[0.14em] text-ink transition-colors hover:border-ink hover:bg-ink/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink sm:self-auto"
          >
